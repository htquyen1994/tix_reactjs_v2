...
export default function Magazine() {
    ...
    return (
        <Container maxWidth="lg" className={classes.root}>
            <Paper>
                <Typography component="h1"  className={`text-center ${classes.title}`} style={{ textTransform: "capitalize" }}>
                    Điện ảnh 24h
                    </Typography>
                <Grid container>
                    <Grid container item xs={12} spacing={3}>
                        <Grid item xs={12} sm={6} md={6} spacing={3}>
                            ...
                            <CardActions>
                                <Button style={{marginLeft: '14px'}} size="small" color="primary">
                                    Xem thêm..
                                </Button>
                            </CardActions>
                        </Grid>
                    ...
                    <Grid container item xs={12} spacing={3}>
                        <Grid item xs={12} sm={6} spacing={3}>
                            <CardMedia className={classes.image}
                                ...
                                alt="Contemplative Reptile"
                                height="100%"
                                image="./images/tiec-trang-mau.png"
